...
export interface BentoCardProps {
    ...
    onClick?: () => void;
    className?: string;
    themeColor?: string; // Expects RGB string like "r, g, b"
}
                ...
                {cards.map((card, index) => {
                    ...
                    const cardProps = {
                        ...
                        style: {
                            ...
                            '--glow-color': card.themeColor || glowColor,
                            '--card-theme-color': card.themeColor || '168, 85, 247' // Default to purple if not set
