        ...
        <div className="space-y-8">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                <Link href="/admin/users">
                    <SpotlightCard className="h-full border border-white/10 bg-white/5 rounded-2xl p-6 hover:bg-white/10 transition-colors" spotlightColor="rgba(99, 102, 241, 0.2)">
                ...
                <Link href="/admin/pending">
                    <SpotlightCard className="h-full border border-yellow-500/20 bg-yellow-500/5 rounded-2xl p-6 hover:bg-yellow-500/10 transition-colors" spotlightColor="rgba(234, 179, 8, 0.2)">
                        {pendingCount > 0 && (
                ...
                <Link href="/admin/approved">
                    <SpotlightCard className="h-full border border-green-500/20 bg-green-500/5 rounded-2xl p-6 hover:bg-green-500/10 transition-colors" spotlightColor="rgba(34, 197, 94, 0.2)">
                        <div className="flex flex-row items-center justify-between pb-2">
                ...
                <Link href="/admin/rejected">
                    <SpotlightCard className="h-full border border-red-500/20 bg-red-500/5 rounded-2xl p-6 hover:bg-red-500/10 transition-colors" spotlightColor="rgba(239, 68, 68, 0.2)">
                        <div className="flex flex-row items-center justify-between pb-2">
            ...
            <div className="grid gap-6">
                <SpotlightCard className="col-span-1 bg-white/5 border border-white/10 rounded-2xl p-6" spotlightColor="rgba(255, 255, 255, 0.1)">
